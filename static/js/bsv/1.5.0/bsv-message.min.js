  ...
  function(t, r, e) {
    ...
    ;(function(r) {
      var n = e(0),
        ...
        u = n.PublicKey,
        f = n.Address,
        s = n.encoding.BufferWriter,
        a = n.crypto.ECDSA,
        h = n.crypto.Signature,
        c = n.crypto.Hash.sha256sha256,
        l = n.util.js,
        p = n.util.preconditions,
        g = function t(e) {
      ...
      ;(g.sign = function(t, r) {
        ...
        (g.prototype.magicHash = function() {
          var t = s.varintBufNum(g.MAGIC_BYTES.length),
            e = s.varintBufNum(this.messageBuffer.length),
            n = r.concat([t, g.MAGIC_BYTES, e, this.messageBuffer])
          return c(n)
        }),
        ...
        (g.prototype.verify = function(t, e) {
          ...
          var n = h.fromCompact(r.from(e, 'base64')),
            o = new a()
          ;(o.hashbuf = this.magicHash()), (o.sig = n)
          var u = o.toPublicKey(),
            s = f.fromPublicKey(u, t.network)
      ...
      function a(t, r, e, n) {
        ...
        return 'undefined' != typeof ArrayBuffer && r instanceof ArrayBuffer
          ...
          : (function(t, r) {
              if (s.isBuffer(r)) {
                var e = 0 | p(r.length)
                return 0 === (t = f(t, e)).length ? t : (r.copy(t, 0, 0, e), t)
              }
              if (r) {
                if (
      ...
      ;(s.prototype.slice = function(t, r) {
        ...
        (s.prototype.fill = function(t, r, e, n) {
          ...
          if (
            ...
            var u = s.isBuffer(t) ? t : F(new s(t, n).toString()),
              f = u.length

  ...
  function(t, e, r) {
    ...
    function s(t, e) {
      return (
        ...
        !(e < 0 || e + 1 >= t.length) && 56320 == (64512 & t.charCodeAt(e + 1))
      )
    }
    function o(t) {
      return (
    ...
    ;(function(e) {
      ...
      ;(h.prototype.verify = function(t, e, s, o, f, a) {
        ...
        if (0 != (f & h.SCRIPT_VERIFY_CLEANSTACK)) {
          ...
          if (1 !== u.length) return (this.errstr = 'SCRIPT_ERR_CLEANSTACK'), !1
        }
        return !0
      }),
        (t.exports = h),
    ...
    ;(function(e) {
      ...
      ;(h.fromBuffer = function(t) {
        ...
        (h.prototype.hasTransaction = function(t) {
          ...
          return this._traverseMerkleTree(s, 0, { txs: i }), -1 !== i.indexOf(r)
        }),
    ...
    ;(t.exports = a),
      ...
      (a.prototype._wnafMulAdd = function(t, e, r, n, i) {
        ...
        for (h = c; h >= 0; h--) {
          for (var I = 0; h >= 0; ) {
            var A = !0
            for (y = 0; y < n; y++) (w[y] = 0 | u[y][h]), 0 !== w[y] && (A = !1)
            if (!A) break
            I++, h--
          }
